...
-- Πρώτα ό,τι έχει foreign key προς TRIP
DROP TABLE IF EXISTS TRIP_SEGMENT;
DROP TABLE IF EXISTS TRIP_VEHICLE_MATCH;
DROP TABLE IF EXISTS PAYMENT_TRANSACTION;

-- Μετά ό,τι έχει foreign key προς VEHICLE / DRIVER
DROP TABLE IF EXISTS SERVICE_CATALOG;
DROP TABLE IF EXISTS VEHICLE_REQUIREMENTS; -- ΠΟΛΥ ΣΗΜΑΝΤΙΚΟ
...
-- Τώρα πλέον δεν εξαρτάται κανείς από SERVICE_TYPE
DROP TABLE IF EXISTS SERVICE_TYPE;

-- Τελευταίοι οι user tables
