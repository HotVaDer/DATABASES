...
DROP TABLE IF EXISTS USER_TYPE_MAP
...
(
  ...
  File_URL VARBINARY(MAX) NOT NULL,
  User_ID INT NOT NULL,
...
(
  ...
  Photo_URL VARBINARY(MAX) NOT NULL,
  License_Plate VARCHAR(10) NOT NULL,
...
(
  ...
  Must_Be_4_Door BINARY NOT NULL,
  Must_Have_Rear_Seats BINARY NOT NULL,
